...
<main>
  <div class="upload">
      ...
      <form action="upload.php" method="POST" enctype="multipart/form-data">
        <input type="file" name="file" placeholder="URL to the file" id="imageInput" accept=".png,.jpg,.jpeg,.svg,.mov,.mkv,.avi,.mp4,.wav,.mp3" />
        <div class="upload-field" id="dropZone" >
          <div class="icon-field" ><span class="fa fa-file-o"></span>
            <p>Drag your image here</p>
          </div>
        </div>
        <input class="focus-out" type="submit" name="submit" value="UPLOAD" id="upload-btn"/>
      </form>
    </div>
  </div>
</main>
<button id="mostraMediaButton">Mostra Media</button>
